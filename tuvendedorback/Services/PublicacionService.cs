...
public class PublicacionService : IPublicacionService
{
    ...
    public Task<int> CrearPublicacion(CrearPublicacionRequest request, int idUsuario)
    {
        ...
        {
            var url = await _imageStorage.SubirImagenWebPAsync(img);
            urls.Add(url);
        }

        return await _repository.InsertarPublicacionAsync(request, idUsuario, urls);
    }
}
